...
#define MAX7219_WIDTH         64
#define MAX7219_HEIGHT        16
#define MAX7219_FB_SIZE       (MAX7219_WIDTH / 8 * 16)
#define MAX7219_MAX_BR        16

#define MATRIX_CNT            ((MAX7219_WIDTH / 8) * (MAX7219_HEIGHT / 8))
...
void max7219SendDataBuf(uint16_t *buf);
